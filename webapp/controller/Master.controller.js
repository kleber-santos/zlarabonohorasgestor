...
sap.ui.define([
	...
	return BaseController.extend("whr.com.br.ZLARAbonoHorasGestor.controller.Master", {
		...
		onSearch: function (oEvt) {
			...
			if (sQuery && sQuery.length > 0) {
				var filter = new Filter("Stext", sap.ui.model.FilterOperator.Contains, sQuery);
		...
		onOpenViewSettings: function (oEvent) {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("whr.com.br.ZLARAbonoHorasGestor.view.ViewSettingsDialog", this);
		...
		initCabecalho: function () {
			...
			try {
				...
				var that = this;
				//	var oView = new sap.ui.view({viewName:"Detail", type:sap.ui.core.mvc.ViewType.JS});
